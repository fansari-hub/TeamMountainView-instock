      ...
      <form ref={ref} className={`form ${className}`}>
        ...
        {fieldsToRender.map((field, index) => {
          if (field.name === "status") {
            return (
              <div key={index}>
                <h3 className="font-H3-label form__field-title">
                  {field.title}
                </h3>
                <div className="form__labelHolder">
                  <label
                    className={`font-P2-BodyMedium form--fontSize ${
                      selectedStatus === "in_stock" ? "activeSelect" : ""
                    }`}
                  >
                    <input
                      type="radio"
                  ...
                  <label
                    className={`font-P2-BodyMedium form--fontSize ${
                      selectedStatus === "out_of_stock" ? "activeSelect" : ""
                    }`}
                  >
                    <input
                      type="radio"
          ...
          if (field.name === "quantity") {
            return (
              <div
                key={index}
                className={`${
                  selectedStatus === "out_of_stock" ? "hide-quantity" : ""
                }`}
              >
                <h3 className="font-H3-label form__field-title">
                  {field.title}
