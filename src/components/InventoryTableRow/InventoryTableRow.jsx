...
const InventoryTableRow = ({
  ...
  const handleDeleteConfirm = async () => {
    try {
      ...
      setInventoryData(
        inventoryData.filter((inventory) => inventory.id !== selectInventoryId)
      );
      SetIsModalOpen(false);
    } catch (error) {
  ...
  if (warehouse_filtered !== true) {
    wareHouseDiv = (
      <>
        <div className="InventoryTableRow__main__info__col__field__label font-H4-TableHeader">
          WAREHOUSE
        </div>
        <div className="InventoryTableRow__main__info__col__field__data font-P2-BodyMedium">
  ...
  let parentPathPrefix = "/Inventory/";
  if (location.pathname.toLowerCase().endsWith("/inventory")) {
    parentPathPrefix = "";
  }
        ...
        <div className="InventoryTableRow__main">
          <div className="InventoryTableRow__main__info">
            <div className="InventoryTableRow__main__info__col">
              <div
                className="InventoryTableRow__main__info__col__field"
              ...
              >
                ...
                <NavLink
                  to={parentPathPrefix + inventory.id + "/"}
                  className="InventoryTableRow__main__info__col__field__label__link"
                >
                  <div className="InventoryTableRow__main__info__col__field__data InventoryTableRow__main__info__col__field__data--link font-H3-label">
                    {inventory.item_name}
                  </div>
                  <img
                    src="/src/assets/images/Icons/chevron_right-24px.svg"
                    alt="link icon"
                    className="InventoryTableRow__main__info__col__field__label__link__icon"
                  />
                </NavLink>
              </div>
              <div
            ...
            <div className="InventoryTableRow__main__info__col">
              ...
              >
                ...
                <div className={stockTickerClass}>
                  <div className="InventoryTableRow__main__info__col__field__data font-P3-BodySmall">
            ...
            <div className="InventoryTableRow__main__info__col InventoryTableRow__main__info__col--actions">
              ...
              >
                <div className="InventoryTableRow__main__info__col__field__icons">
                  <img
                    onClick={() => {
                      handleDeleteClick(inventory.id);
                    }}
                    className="InventoryTableRow__main__info__col__field__icons__delete"
