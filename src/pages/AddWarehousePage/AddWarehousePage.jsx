      ...
      <div className="AddWarehousePage">
        ...
        <main className="AddWarehousePage__container">
          <div className="AddWarehousePage__container__header">
            ...
            <h1 className="font-H1-PageHeader AddWarehousePage__container__header-title">
              Add New Warehouse
            </h1>
          </div>
          ...
          <div className="AddWarehousePage__two-forms">
            <NewWarehouseForm
              className="AddWarehousePage__two-forms__first"
            ...
            <NewWarehouseForm
              className="AddWarehousePage__two-forms__second"
              warehouesToEdit={placeholderText}
              formType="contact"
              ref={contactFormRef}
            />
          ...
          <div className="AddWarehousePage__container__footer">
            <button
              className="font-H3-label AddWarehousePage__container__footer-cancel"
              onClick={handleCancel}
            >
              Cancel
            </button>
            <button
              className="font-H3-label AddWarehousePage__container__footer-save"
              onClick={handleSave}
            >
              Save
            </button>
