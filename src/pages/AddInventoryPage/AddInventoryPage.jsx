      ...
      <div className="AddInventoryPage">
        ...
        <main className="AddInventoryPage__container">
          <div className="AddInventoryPage__container__header">
            ...
            <h1 className="font-H1-PageHeader AddInventoryPage__container__header-title">Add New Inventory Item</h1>
          </div>
          <hr className="AddInventoryPage__container__divider" />

          <div className="AddInventoryPage__two-forms">
            <InventoryAdd className="AddInventoryPage__two-forms__first" inventoryToEdit={placeholderText} formType="inventory" ref={inventoryFormRef} />
            <hr className="AddInventoryPage__two-forms__divider" />
            <InventoryAdd className="AddInventoryPage__two-forms__second" inventoryToEdit={placeholderText} formType="item availability" ref={itemAvailabilityFormRef} warehouses={warehouses} />
          </div>
          ...
          <div className="AddInventoryPage__container__footer">
            <div className="AddInventoryPage__container__footerHolder">
              <button className="font-H3-label AddInventoryPage__container__footer-cancel AddInventoryPage__cancelBtn--holder">
                <Link className="AddInventoryPage__cancelBtn" to="/inventory">
                  Cancel
                </Link>
              </button>
              <button className="font-H3-label AddInventoryPage__container__footer-save AddInventoryPage__submitBtn" onClick={handleSave}>
                + Add Item
              </button>
            </div>
          </div>
